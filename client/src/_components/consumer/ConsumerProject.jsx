                  ...
                  <CardHeader className="pb-2">
                    <div className="flex justify-between items-center">
                      <Avatar className="h-12 w-12">
                        ...
                        />
                        <AvatarFallback>
                          {project.company.CompanyDetail.companyName.charAt(0)}
                        </AvatarFallback>
                      </Avatar>
                  ...
                  <CardContent>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center text-sm">
                        ...
                        <span>ROI: {project.quotation.latestVersion.roi}</span>
                      </div>
                    </div>
                  </CardContent>
                  <CardFooter>
              ...
              <div className="space-y-8">
                {selectedProject.quotation.latestVersion.status !==
                  ...
                  <Alert variant="warning">
                    ...
                    <AlertDescription>
                      Your project quotation is not yet finalized. We recommend
                      working closely with{" "}
                      {selectedProject.company.CompanyDetail.companyName} to
                      refine the project details and come to an agreement. This
                      ensures the best outcome for your solar installation.
                    </AlertDescription>
                  </Alert>
                )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-2">
                      <InfoItem
                        label="Savings"
                        value={selectedProject.quotation.latestVersion.savings}
                      />
                      <InfoItem
                        label="Payback Period"
                        value={
                          selectedProject.quotation.latestVersion.paybackPeriod
                        }
                      />
                      <InfoItem
                        label="ROI"
                            ...
                            {selectedProject.quotation.latestVersion.costBreakdown.map(
                              (item, index) => (
                                ...
                                >
                                  ...
                                  <td className="py-2">RM {item.unitPrice}</td>
                                  <td className="py-2">RM {item.totalPrice}</td>
                                </tr>
                              )
                            )}
                          </tbody>
                ...
                <Card>
                  ...
                  <CardContent>
                    ...
                    selectedProject.steps.length > 0 ? (
                      ...
                      <p className="text-sm text-muted-foreground">
                        The company hasn&apos;t drafted the steps for this solar
                        journey yet. Check back soon for updates!
                      </p>
                    )}
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-2">
                    <InfoItem
                      label="Company Name"
                      value={selectedProject.company.CompanyDetail.companyName}
                    />
                    <InfoItem
                      label="Address"
                    ...
                    <InfoItem
                      label="Phone"
                      value={selectedProject.company.CompanyDetail.phoneNumber}
                    />
